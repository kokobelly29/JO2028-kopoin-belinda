...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($statementCheck->rowCount() > 0) {
            ...
            $statement->bindParam(":adresseLieu", $adresseLieu, PDO::PARAM_STR); // Corrected parameter name
            $statement->bindParam(":cpLieu", $cpLieu, PDO::PARAM_STR); // Corrected parameter name
            $statement->bindParam(":villeLieu", $villeLieu, PDO::PARAM_STR); // Corrected parameter name
